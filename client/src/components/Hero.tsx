          ...
          <div className="container mx-auto px-6 z-10 relative pt-20">
            <div className="flex flex-col lg:flex-row gap-16">
              ...
              <div className="hidden lg:block lg:w-1/2 relative">
                ...
                >
                  <div className="w-full h-full rounded-2xl bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/10 shadow-2xl overflow-hidden relative">
                    ...
                    <div className="p-8 relative">
                      ...
                      <div className="mt-8 space-y-4">
                        <div className="h-24 w-full bg-red-500/20 rounded-md border border-red-500/30" />
                        <div className="h-24 w-full bg-white/5 rounded-md border border-white/10" />
                      </div>
                    </div>
                  </div>
                </motion.div>
